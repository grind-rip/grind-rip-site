...
* Read [14 Patterns to Ace Any Coding Interview Question](https://hackernoon.com/14-patterns-to-ace-any-coding-interview-question-c5bb3357f6ed). My notes on this article can be found [here]({{< relref "notes.md" >}}).

## Day 3 (2024-01-14)

* Completed [Two Sum](https://leetcode.com/problems/two-sum)
...
* Completed [Best Time to Buy and Sell Stock](https://leetcode.com/problems/best-time-to-buy-and-sell-stock)
...
* Did the following easy problems for fun:
